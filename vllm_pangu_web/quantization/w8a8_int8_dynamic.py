...
MODEL_ID = "/opt/pangu/openPangu-Embedded-1B-V1.1"
model = PanguEmbeddedForCausalLM.from_pretrained(MODEL_ID, dtype="auto", trust_remote_code=True)
...
SAVE_DIR = MODEL_ID.rstrip("/")+ "-W8A8-Dynamic-Per-Token"
